            ...
            <CajaUsuario>
              ...
              <CajaDatos>
                <div>
                  <CajitaDatos>
                    <Texto>Nombre:</Texto>
                    <Texto className="detalle">{userSelect?.nombre}</Texto>
                  </CajitaDatos>
                  <CajitaDatos>
                    <Texto>Apellido:</Texto>
                    <Texto className="detalle">{userSelect?.apellido}</Texto>
                  </CajitaDatos>
                  <CajitaDatos>
                    <Texto>Sucursal:</Texto>
                    <Texto className="detalle">{userSelect?.sucursal}</Texto>
                  </CajitaDatos>
                  <CajitaDatos>
                    <Texto>Departamento:</Texto>
                    <Texto className="detalle">{userSelect?.dpto}</Texto>
                  </CajitaDatos>
                  <CajitaDatos>
                    <Texto>Posición:</Texto>
                    <Texto className="detalle">{userSelect?.posicion}</Texto>
                  </CajitaDatos>
