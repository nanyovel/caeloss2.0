...
const navegacion = useNavigate()
     ...
     const initialPrivilegios=[
        {
            code:'fullAccessIMS',
            valor:false,
            descripcion:'Acceso total al sistema de gestion de importaciones, abarca lectura y escritura en su totalidad.'
        },
        {
            code:'fullAccessTMS',
            valor:false,
            descripcion:'Acceso total al sistema de gestion de transporte, abarca lectura y escritura en su totalidad.'
        },
        {
            code:'fullAccessMMS',
            valor:false,
            descripcion:'Acceso total al sistema de gestion de mantenimiento, abarca lectura y escritura en su totalidad.'
        },
        {
    ...
    const initialValueNuevoUser={
        ...
        fechaRegistro: format(new Date(),`dd/MM/yyyy hh:mm:ss:SSS aa`, {locale:es}),
    }

    const [nuevoUser, setNuevoUser]=useState({...initialValueNuevoUser})
    ...
    const handleSubmit=async(e)=>{
        ...
        if(datos.correo==''||datos.password==''||datos.repetirPassword==''){
        ...
        if(expReg.correo.test(datos.correo)==false){
            ...
            if(validacion.hasCamposLlenos==true&&
                validacion.hasCorreoGrupo==true&&
                validacion.passwordIguales==true
                ){
                    setIsLoading(true)
                    try{
                        await createUserWithEmailAndPassword(autenticar,datos.correo,datos.password)
                        const auth=getAuth()
