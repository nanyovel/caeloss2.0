...
import { faSave, faUser, faUserEdit, faUserLock, faUserPen, faXmark } from '@fortawesome/free-solid-svg-icons'
    ...
    const guardarCambios=async()=>{
        ...
        if(userMaster){
            ...
            try {
                ...
                if(fotoPerfil){
                    await uploadBytes(storageRefFoto, fotoPerfil).then((snapshot) => {
                    });
