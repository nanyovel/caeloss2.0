...
import platanera from './img/carros/platanera.png'
import camaLarga from './img/carros/camaLarga.png'
import patana from './img/carros/patana.png'
import platanera10Pies from './img/carros/platanera10Pies.png'
import rigido from './img/carros/rigido.png'
import Select from 'react-select'
import { Header } from '../components/Header'
import {dbMunicipios, dbProvincias } from './DBFletex'
...
export const Fletes = ({
  ...
  extraerGrupoPorCondicion('valoresUnidadVehicular', setDBValoresUV)
  ...
  const handleSelectMun=(e)=>{
    ...
    setProvinciasParsed(provinciasParsed.map((pro,index)=>{
      const muni=pro.municipios.map((mun,i)=>{
        return{
          ...mun,
  ...
  useEffect(()=>{
    ...
    // Dame el vehiculo
    const vehiSelect=opcionesVehiculos?.find((veh,i)=>{
      if(veh.select==true){
...
const ContenedorDestinos=styled.div`
  @media screen and (max-width: 500px){
...
background-color: red;
`
const BtnSetup=styled(BtnGeneralButton)
