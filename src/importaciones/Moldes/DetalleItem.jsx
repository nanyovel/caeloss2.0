...
export const DetalleItem = ({
  ...
  const buscarDoc = (e) => {
    ...
    if (
      ...
      navigate("/importaciones/maestros/articulos/" + buscarDocInput);
      setBuscarDocInput("");
  ...
  }, [userMaster, todosItemsBL, navigate]);
  ...
  const handleChange = async (e) => {
    ...
    const seguiExistBL = userMaster?.seguimientos?.find(
      (segui) => segui.codigoItem == todosItemsBL[0]?.codigo
    );
    const seguiExistOC = userMaster?.seguimientos?.find(
      (segui) => segui.codigoItem == todosItemsOC[0]?.codigo
    );
        ...
        <CajaEncabezado>
          <CajaDetalles>
            ...
            <CajitaDetalle>
              ...
              <DetalleTexto title={todosItemsBL[0]?.descripcion}>
                {todosItemsBL[0]?.descripcion}
              </DetalleTexto>
            </CajitaDetalle>
          </CajaDetalles>
...
/> */}
        ...
        location.pathname != "/importaciones/maestros/billoflading" ? (
          ...
          <>
            ...
            <TextoDescriptivo>
              La siguiente es una lista de este ítem de todas las cantidades ya
              enviadas por el proveedor hacia nuestros almacenes, en proceso de
              importación.
            </TextoDescriptivo>
                  ...
                  {todosItemsBL.map((item, index) => {
                    return (
                      <Filas key={index} className="body">
                        ...
                        <CeldasBody>
                          {item.llegadaSap ? item.llegadaSap.slice(0, 10) : ""}
                        </CeldasBody>
                        <CeldasBody>
                          <Enlaces
        ...
        location.pathname != "/importaciones/maestros/billoflading" ? (
          ...
          <>
            ...
            <TextoDescriptivo>
              La siguiente es una lista de todas las cantidades de este ítem que
              ya le solicitamos al proveedor, pero este aun no carga el
              contenedor para enviar hacia Rep. Dominicana.
            </TextoDescriptivo>
