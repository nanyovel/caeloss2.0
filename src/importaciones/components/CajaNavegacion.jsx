...
const CajaNavegacion = ({ pageSelected = false, userMaster }) => {
    ...
    switch (e.target.name) {
      ...
      case "Maestros":
        if (location.pathname == "/importaciones/maestros") {
          ...
          navigate("/importaciones/maestros");
        }
        break;
      case "Seguimientos":
        if (location.pathname == "/importaciones/seguimientos") {
          ...
          navigate("/importaciones/seguimientos");
        }
        break;
      case "Ciclo":
