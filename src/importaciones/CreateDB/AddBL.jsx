...
// Si algun furgon no tiene numero
    ...
    blEditable.furgones.forEach((furgon,index)=>{
      if(furgon.numeroDoc==''){
        faltaNumero=true
        return''  
      }
...
// Es util colocarlo "por si acaso"
    ...
    if(
      ...
      const furgonesParsed=blEditable.furgones.map((furgon,iXndex)=>{
        const materialParsed=furgon.materiales.map((item,index)=>{
          return {
            ...item,
            furgon:furgon.numeroDoc
          }
