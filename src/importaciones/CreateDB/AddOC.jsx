  ...
  const handlePaste1 = (index, elm, e) => {
    setinputvalue((inputvalue) => ({
      ...
      inputs: inputvalue.inputs.map((item, i) => {
        ...
        if (e.target.value == "Codigo" && elm == "Codigo") {
          valueParse = "";
        }
        if (
        ...
        if (e.target.value == "Cantidad" && elm == "Qty") {
          valueParse = "";
        }
        if (e.target.value == "Detalles de artículo" && elm == "Comentarios") {
          valueParse = "";
        }
          ...
          <EncabezadoTabla>
            <Filas className="text-center">
              {label.labels.map((elm, ind) => {
                return <CeldasHead key={ind}>{elm}</CeldasHead>;
              })}
            </Filas>
          </EncabezadoTabla>
          <Cuerpo>
